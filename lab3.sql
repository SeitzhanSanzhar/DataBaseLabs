...
SELECT count(employees), department FROM employees GROUP BY department;
SELECT count(employees), department FROM employees GROUP BY department HAVING count(employees) > 2;
SELECT ALL * FROM departments ORDER BY -budget OFFSET 1 LIMIT 1;
SELECT name FROM customers WHERE city = 'Almaty';
SELECT name FROM employees WHERE city = 'Almaty';
SELECT ALL * FROM departments WHERE budget > 60000 ORDER BY code DESC;

UPDATE departments SET budget = budget * 0.9 WHERE budget = (SELECT budget FROM departments ORDER BY budget ASC LIMIT 1);
UPDATE departments SET name = 'IT' WHERE name = 'Research';
DELETE FROM employees USING departments WHERE department = departments.code AND departments.name = 'IT';
